function C01_specification_runs(output_dir, pre_data_dir, runs, subs, delay_sim_1, delay_alt_1, delay_sim_2, delay_alt_2, delay_sim_3, delay_alt_3)

%% Create data 
% this is practically the same code for all three participants but adapted
% for their individual subject numbers to fill the matlabbatch accordingly
% it takes in an output-directory for the resulting SPM.mat file, the runs,
% all subjects as an array, a directory guiding to the data and the amount
% of stimuli it took each participant to switch conditions (delay...) to
% alter the onsets 
